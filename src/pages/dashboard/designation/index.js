...
import { getdesignation , deleteDesignation} from '../../../redux/slices/designation';
// routes
...
// sections
import { DesignationTableRow , DesignationTableToolbar } from '../../../sections/@dashboard/designation';
...
export default function Designation() {
  ...
  const { isLoading, designations } = useSelector((state) => state.designationnar); 
  ...
  const handleDeleteRow = (id) => {
    dispatch(deleteDesignation(id, toast));
